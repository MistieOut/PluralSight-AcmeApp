    ...
    public class VendorTests
    {
        ...
        public void PlaceOrder_3Parameters()
        {
            ...
            var expected = new OperationResult<bool>(true,
                "Order from Acme, Inc\r\nProduct: SawTools-0001" +
                                    "\r\nQuantity: 12" +
                                    "\r\nDeliver By: 1/28/2020" +
                                    "\r\nInstructions: standard delivery");

            //Act
            var actual = vendor.PlaceOrder(product, 12,
                new DateTimeOffset(2020, 1, 28, 0, 0, 0, new TimeSpan(-7, 0, 0)));
        ...
        public void PlaceOrder_4Parameters()
        {
            ...
            //Act
            var actual = vendor.PlaceOrder(product, 12,
                new DateTimeOffset(2020, 1, 28, 0, 0, 0, new TimeSpan(-7, 0, 0)), "Porch");
