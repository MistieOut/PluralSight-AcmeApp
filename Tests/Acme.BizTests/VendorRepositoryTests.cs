...
namespace Acme.Biz.Tests
{
    ...
    public class VendorRepositoryTests
    {
        ...
        [TestMethod()]
        public void RetreivalValueTest()
        {
            //Arrange
            var repository = new VendorRepository();
            var expected = 42;
            ...
            //Act
            var actual = repository.RetreivalValue<int>("Select ...", 42);
        ...
        [TestMethod()]
        public void RetreivalValueStringTest()
        {
            //Arrange
            var repository = new VendorRepository();
            var expected = "test";
            ...
            //Act
            var actual = repository.RetreivalValue<string>("Select ...", "test");
        ...
        [TestMethod()]
        public void RetrivalValueObjectTest()
        {
            //Arrange
            var repository = new VendorRepository();
            ...
            //Act
            var actual = repository.RetreivalValue<Vendor>("Select ...", vendor);
