    ...
    public class Vendor 
    {
                                            ...
                                            string instructions = "standard delivery")
        {
            ...
            var orderTextBuilder = new StringBuilder("Order from Acme, Inc" + System.Environment.NewLine +
                            "Product: " + product.ProductName + product.ProductCode + System.Environment.NewLine +
                            "Quantity: " + quantity);
            ...
            var operationResults = new OperationResult<bool>(success, orderText);
        ...
        /// <param name="sendCopy">True to send a copy of the email to the curr</param>
        /// <returns>Success flat and order text.</returns>
        ...
        public string PrepareDirectionsOnTwoLines()
        {
            ...
            var directions2 = "First do this:" + @" \r\n" + Environment.NewLine + "Then do that";
